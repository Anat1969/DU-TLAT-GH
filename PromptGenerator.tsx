...
export default function PromptGenerator() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (data.success) {
        setPrompt({
          hebrewDescription: data.data.hebrewDescription,
          midjourneyPrompt: data.data.midjourneyPrompt,
          whyItWorks: data.data.whyItWorks,
  ...
  return (
    <div dir="rtl" style={styles.container}>
      ...
      <div style={styles.mainGrid}>
        ...
        {prompt && (
          <div style={styles.section}>
            <h2 style={styles.sectionTitle}>Midjourney Prompt</h2>

            <div style={styles.outputBox}>
              <h3 style={styles.outputSubtitle}>תיאור בעברית</h3>
              <p style={styles.outputText}>{prompt.hebrewDescription}</p>
            </div>

            <div style={styles.outputBox}>
              <h3 style={styles.outputSubtitle}>הפרומפט (העתק ל-Midjourney)</h3>
              <div style={styles.promptDisplay}>
                <p style={styles.promptText}>{prompt.midjourneyPrompt}</p>
              </div>
              <button
                onClick={() => copyToClipboard(prompt.midjourneyPrompt)}
            ...
            <div style={styles.outputBox}>
              <h3 style={styles.outputSubtitle}>למה התמונה הזו עובדת</h3>
              <p style={styles.outputText}>{prompt.whyItWorks}</p>
            </div>
